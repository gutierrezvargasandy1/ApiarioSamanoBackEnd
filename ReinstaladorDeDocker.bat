...
:: =============================
set servicios= MicroServiceAlmacen:microservicealmacen MicroServiceProveedores:microserviceproveedores MicroServiceAuth:microserviceauth MicroServiceProduccion:microserviceproduccion MicroServiceApiarios:microserviceapiarios MicroServiceGestorDeArchivos:microservicegestordearchivos  MicroServiceUsuario:microserviceusuario MicroServiceNotificacionesGmail:microservicenotificacionesgmail MicroServiceGeneradorCodigo:microservicegeneradorcodigo
